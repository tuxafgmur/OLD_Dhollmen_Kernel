...
static struct global_attr hispeed_freq_attr = __ATTR(hispeed_freq, 0660,
...
static struct global_attr go_hispeed_load_attr = __ATTR(go_hispeed_load, 0660,
...
static struct global_attr min_sample_time_attr = __ATTR(min_sample_time, 0660,
...
static struct global_attr timer_rate_attr = __ATTR(timer_rate, 0660,
...
static struct global_attr sampling_periods_attr = __ATTR(sampling_periods,
			0660, show_sampling_periods, store_sampling_periods);
...
static struct global_attr hi_perf_threshold_attr = __ATTR(hi_perf_threshold,
			0660, show_hi_perf_threshold, store_hi_perf_threshold);
...
static struct global_attr low_power_threshold_attr = __ATTR(low_power_threshold,
		     0660, show_low_power_threshold, store_low_power_threshold);
...
static struct global_attr low_power_rate_attr = __ATTR(low_power_rate,
		     0660, show_low_power_rate, store_low_power_rate);
